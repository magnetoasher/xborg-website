      ...
      <div className="container container-xl">
        <div className="faqs">
          ...
          activeCategories.find((item) => item == "aboutxborg") ? (
            <>
              <Collapsible trigger="What is XBorg?" tag="About XBorg">
                <p>
                  XBorg is building a Gaming Credential and Application Network
                  for players and Decentralized Gaming Societies.
                </p>
                <p>
                  The first application within this network is XBorg.gg, the
                  ultimate gaming platform for players and fans. Players can
                  earn limited-edition collectables based on their gaming skills
                  and social reputation.
                </p>
                <p>
                  With support from more than 10,000 players, including the best
                  players in the Web3 community, XBorg has established itself as
                  a leading player in the Web3 gaming space.
                </p>
              </Collapsible>
              <Collapsible trigger="Who’s behind XBorg?" tag="About XBorg">
                <p>
                  XBorg is a{" "}
                  <a
                  ...
                  XBorg team members can be found here. Most importantly, XBorg
              ...
              <Collapsible trigger="How can I contact you?" tag="About XBorg">
                <p>
            ...
            <>
              ...
              >
                ...
                <p>
                  ...
                  <br />
                  Receive an airdrop of XBG tokens, partner tokens and NFTs, and
                  get access to XBorg's seed investment round at a discounted
                  valuation.
                </p>
                <p>
              ...
              >
                ...
                <p>
                  ...
                  period, each Prometheus holder will have a guaranteed
                  allocation up to $3,000 per NFT held.
                </p>
                <p>
                  However, you can also invest in XBorg via SwissBorg’s vaults.
                </p>
              </Collapsible>
            </>
          ) : null}
          ...
          activeCategories.find((item) => item == "fundraising") ? (
            <>
              ...
              >
                ...
                <p>
                  If you are investing via SwissBorg’s, the KYC process will be
                  done via the app directly.
                </p>
              </Collapsible>
              ...
              >
                <p>
                  ...
                  difference between the private and the public round are the
                  price, the allocation, and the locking period. The seed price
                  is substantially lower than the public price.
                </p>
              </Collapsible>
            </>
          ) : null}
            ...
            <>
              ...
              >
                <p>
                  ...
                  $40'000 per month, meaning that XBorg has 20 months of runway
                  left, assuming that no profits are generated. The treasury is
                  maintained in multiple gnosis safe (multi sigs), handled by
                  Louis, the SwissBorg treasurer, and one SwissBorg executive.
                </p>
              </Collapsible>
