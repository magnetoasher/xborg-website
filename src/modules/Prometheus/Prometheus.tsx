          ...
          <div className="list-data row row-wrap">
            <div className="col">
              ...
              <div className="desc">
                ...
                governance. Witness the depth of our cutting-edge protocol as we
                build groundbreaking products together.
              </div>
            </div>
            ...
            <div className="col">
              <div className="title">Whitelists & early game opportunities</div>
              <div className="desc">
            ...
            <div className="col">
              ...
              <div className="desc">
                Be the first to access products like Launchpad opportunities and
                benefit from a 0 fee experience. You can’t beat the Prometheus
                status.
              </div>
            </div>
            ...
            <div className="col">
              ...
              <div className="desc">
                Be the first to experience XBorg's innovative esports and gaming
                products, including the first large-scale Esports DAO launching
                in Q2 2023.
              </div>
            </div>
            ...
            <div className="col">
              ...
              <div className="desc">
                Know exactly what’s happening in the behind the scenes. Be aware
                of all upcoming news. Oh, and sometimes you may find some Alpha.
              </div>
            </div>
          </div>
